...
class MenuScene : public Scene{
    ...
    private:
        ...
        enum buttons{ CONTINUE, NEW_GAME, NEW_YES, NEW_NO, OPTIONS, EXIT, EXIT_YES, EXIT_NO, VOLUME_GRP, GRAPHICS_GRP, CONTROLS_GRP, BACK, SAVE, KEYBINDINGS_CLOSE, GRAPHICS_YES, GRAPHICS_NO } button;
        enum windowBox{ CNFRM_NEW_GAME, CNFRM_EXIT, CNFRM_GRAPHICS } windowBox;
        ...
        int savedVsyncValue, savedFpsValue;
        float timer;
};
